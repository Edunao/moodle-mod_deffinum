...
$string['virtual_reality_instructions'] = 'Voici le lien de téléchargement vers le module de Réalité Virtuelle à déposer dans votre casque.<br>{$a->downloadlink}.<br>Une fois le module lancé, vous serez invité à vous connecter avec vos identifiants Moodle en indiquant le code suivant <strong style="font-size: 120%">{$a->scoid}</strong> afin de suivre votre progression.';
$string['virtual_reality_instructions_link'] = 'Lien de téléchargement';
