...
/**
 * The mod_deffinum tracks viewed event.
 *
...
/**
 * The mod_deffinum tracks viewed event class.
 *
 * @property-read array $other {
 *      Extra information about event properties.
 *
 *      - int attemptid: Attempt id.
 *      - int instanceid: Instance id of the deffinum activity.
...
class tracks_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the tracks for the user with id '$this->relateduserid' " .
            "for the deffinum activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventtracksviewed', 'mod_deffinum');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/deffinum/userreporttracks.php', $params);
    }
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['scoid'] = array('db' => 'deffinum_scoes', 'restore' => 'deffinum_scoe');
