...
/**
 * The mod_deffinum interactions viewed event.
 *
...
/**
 * The mod_deffinum interactions viewed event class.
 *
...
class interactions_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinteractionsviewed', 'mod_deffinum');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/deffinum/userreportinteractions.php', $params);
    }
