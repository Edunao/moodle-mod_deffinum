...
/**
 * The mod_deffinum raw score submitted event.
 *
...
/**
 * The mod_deffinum raw score submitted event class.
 *
...
class scoreraw_submitted extends cmielement_submitted {
    ...
    public static function get_name() {
        return get_string('eventscorerawsubmitted', 'mod_deffinum');
    }
    ...
    protected function validate_data() {
        ...
        // Note: we trust that 'cmivalue' represents a valid DEFFINUM CMI score value.
    }
}
