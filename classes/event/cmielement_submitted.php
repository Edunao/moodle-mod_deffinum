...
/**
 * The mod_deffinum generic CMI element submitted event.
 *
...
/**
 * The mod_deffinum generic CMI element submitted event class.
 *
...
abstract class cmielement_submitted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'deffinum_scoes_value';
    }
    ...
    public function get_description() {
        return "The user with the id '$this->userid' submitted the element '{$this->other['cmielement']}' " .
                ...
                "for a deffinum activity with the course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/deffinum/report/userreport.php',
