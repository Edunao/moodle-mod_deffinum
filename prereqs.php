...
$PAGE->set_url('/mod/deffinum/prereqs.php', array('scoid' => $scoid, 'attempt' => $attempt, 'id' => $cm->id));
...
if (confirm_sesskey() && (!empty($scoid))) {
    ...
    if (has_capability('mod/deffinum:savetrack', context_module::instance($cm->id))) {
        $result = deffinum_get_toc($USER, $deffinum, $cm->id, TOCJSLINK, $currentorg, $scoid, $mode, $attempt, true, false);
        echo $result->toc;
    }
}
