...
//
function AICCapi(def, cmiobj, deffinumauto, cfgwwwroot, deffinumid, scoid, attempt, viewmode, currentorg, sesskey, cmid, autocommit) {
...
M.deffinum_api.init = function(Y, def, cmiobj, deffinumauto, cfgwwwroot, deffinumid, scoid, attempt, viewmode, currentorg, sesskey, cmid, autocommit) {
    window.API = new AICCapi(def, cmiobj, deffinumauto, cfgwwwroot, deffinumid, scoid, attempt, viewmode, currentorg, sesskey, cmid, autocommit);
}
