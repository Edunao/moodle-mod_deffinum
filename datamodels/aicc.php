...
$PAGE->requires->js_init_call('M.deffinum_api.init', array($def, $cmiobj, $deffinum->auto, $CFG->wwwroot, $deffinum->id, $scoid,
                                                            $attempt, $mode, $currentorg, sesskey(), $id, $deffinum->autocommit));
