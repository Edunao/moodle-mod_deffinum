...
/**
 * Defines the version of deffinum_interactions
...
class mod_deffinum_report_interactions_settings extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('advcheckbox', 'qtext', '', get_string('summaryofquestiontext', 'deffinumreport_interactions'));
        $mform->addElement('advcheckbox', 'resp', '', get_string('summaryofresponse', 'deffinumreport_interactions'));
        $mform->addElement('advcheckbox', 'right', '', get_string('summaryofrightanswer', 'deffinumreport_interactions'));
        $mform->addElement('advcheckbox', 'result', '', get_string('summaryofresult', 'deffinumreport_interactions'));
