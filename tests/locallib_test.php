...
/**
 * File containing the DEFFINUM module local library function tests.
 *
...
/**
 * Class containing the DEFFINUM module local library function tests.
 *
 * @package mod_deffinum
 * @category test
 * @copyright 2017 Mark Nelson <markn@moodle.com>
...
final class locallib_test extends \advanced_testcase {
    ...
    public function test_deffinum_update_calendar(): void {
        global $DB;
        ...
        $time = time();
        $deffinum = $this->getDataGenerator()->create_module('deffinum',
            array(
                'course' => $course->id,
                'timeopen' => $time
            )
        ...
        $this->assertEquals('deffinum', $event->modulename);
        $this->assertEquals($deffinum->id, $event->instance);
    ...
    public function test_deffinum_update_calendar_time_open_update(): void {
        global $DB;
        ...
        deffinum_update_calendar($deffinum, $deffinum->cmid);
    ...
    public function test_deffinum_update_calendar_time_open_delete(): void {
        global $DB;
    ...
    public function test_deffinum_update_calendar_time_close(): void {
        global $DB;
    ...
    public function test_deffinum_update_calendar_time_close_update(): void {
        global $DB;
        ...
        $deffinum->timeclose = $time + DAYSECS;
        deffinum_update_calendar($deffinum, $deffinum->cmid);
    ...
    public function test_deffinum_update_calendar_time_close_delete(): void {
        global $DB;
