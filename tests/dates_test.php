...
/**
 * Contains unit tests for mod_deffinum\dates.
 *
...
/**
 * Class for unit testing mod_deffinum\dates.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class dates_test extends advanced_testcase {
     ...
     * @param int|null $timeopen The 'available from' value of the deffinum.
     * @param int|null $timeclose The 'available to' value of the deffinum.
    ...
    public function test_get_dates_for_module(?int $timeopen, ?int $timeclose, array $expected): void {
        ...
        $this->setAdminUser();
        $deffinum = $this->getDataGenerator()->create_module('deffinum', $data);
