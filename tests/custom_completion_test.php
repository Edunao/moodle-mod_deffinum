...
use mod_deffinum\completion\custom_completion;
...
/**
 * Class for unit testing mod_deffinum/custom_completion.
 *
...
final class custom_completion_test extends advanced_testcase {
    ...
    public static function get_state_provider(): array {
        ...
        // Prepare various reusable user deffinum track data used to mock various completion states/requirements.
    ...
    public function test_get_state(string $rule, int $rulevalue, array $uservalue, int $maxattempts, ?int $status,
        ...
        // Mock the DB call fetching user's DEFFINUM track data.
