@mod @mod_deffinum @core_completion
Feature: Deffinum activity default completion
  ...
  Scenario: Completion conditions when there is no default set at site or course level.
    ...
    When I click on "Add a new DEFFINUM" "link" in the "Add an activity or resource" "dialogue"
  ...
  Scenario: Completion conditions when default completion is set at site level but not at course level.
    ...
    And I click on "Expand DEFFINUM" "button"
    And I set the following fields to these values:
      | id_completion_deffinum_2    | 1 |
      | completionview_deffinum     | 1 |
      | completionstatusrequired_deffinum[4] | 0 |
      | completionstatusrequired_deffinum[2]   | 0 |
    And I click on "Save changes" "button" in the "[data-region='activitycompletion-deffinum']" "css_element"
    And I am on "Course 1" course homepage with editing mode on
    And I press "Add an activity or resource"
    When I click on "Add a new DEFFINUM" "link" in the "Add an activity or resource" "dialogue"
    And I expand all fieldsets
  ...
  Scenario: Completion conditions when 'Passed' is marked as default but 'Completed' is unmarked.
    ...
    And I set the following fields to these values:
      ...
      | completionview_deffinum     | 1 |
      | completionstatusrequired_deffinum[4] | 0 |
      | completionstatusrequired_deffinum[2]   | 1 |
    And I click on "Save changes" "button" in the "[data-region='activitycompletion-deffinum']" "css_element"
    And I am on "Course 1" course homepage with editing mode on
    And I press "Add an activity or resource"
    When I click on "Add a new DEFFINUM" "link" in the "Add an activity or resource" "dialogue"
