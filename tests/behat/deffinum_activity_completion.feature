@mod @mod_deffinum @core_completion @_file_upload @_switch_iframe
Feature: View activity completion in the DEFFINUM activity
  In order to have visibility of deffinum completion requirements
  As a student
  I need to be able to view my deffinum completion progress
  ...
  Background:
    ...
    And the following "activity" exists:
      ...
      # Add requirements
      | packagefilepath          | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12-mini.zip |
  ...
  @javascript
  Scenario: A teacher can view a DEFFINUM activity automatic completion conditions
    Given I am on the "Music history" "deffinum activity" page logged in as teacher1
  ...
  @javascript
  Scenario: A student can complete a DEFFINUM activity by achieving a passing grade
    Given I am on the "Music history" "deffinum activity" page logged in as student1
    ...
    And I switch to "deffinum_object" iframe
    And I wait until the page is ready
    And I click on "[id='question_com.deffinum.golfsamples.interactions.playing_1_1']" "css_element"
    ...
    And I switch to "deffinum_object" iframe
    And I wait until the page is ready
    And I click on "[id='question_com.deffinum.golfsamples.interactions.fun_1_False']" "css_element"
    And I press "Submit Answers"
    ...
    And I wait until the page is ready
    And I switch to the main frame
    When I am on the "Music history" "deffinum activity" page
    ...
    # this is because the DEFFINUM does not return a score and also that the completion is not possible anymore (as all attempts are used).
    And the "Receive a score of 3 or more" completion condition of "Music history" is displayed as "todo"
  ...
  @javascript
  Scenario: A student can manually mark the deffinum activity as done but a teacher cannot
    Given I am on the "Music history" "deffinum activity" page logged in as teacher1
    ...
    And I log out
    # Student view.
    When I am on the "Music history" "deffinum activity" page logged in as student1
