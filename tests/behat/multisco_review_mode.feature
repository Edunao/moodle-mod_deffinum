...
Feature: Deffinum multi-sco review mode.
  ...
  Scenario: Test review mode with a single sco completion.
    When the following "activities" exist:
      ...
      | deffinum    | C1     | Basic Multi-sco DEFFINUM package  | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12.zip      | 0               |
    And I am on the "Basic Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    ...
    And I should see "Basic Multi-sco DEFFINUM package"
    And I am on the "Basic Multi-sco DEFFINUM package" "deffinum activity" page
    And I should see "Enter"
    And I press "Enter"
  ...
  Scenario: Test review mode with all scos completed.
    When the following "activities" exist:
      | activity | course | name                           | packagefilepath                                               | forcenewattempt |
      | deffinum    | C1     | ADV Multi-sco DEFFINUM package    | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12.zip      | 0               |
    And I am on the "ADV Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    And I should see "Enter"
    And I press "Enter"
    And I switch to "deffinum_object" iframe
    And I should see "Play of the game"
    ...
    And I follow "Exit activity"
    And I wait until the page is ready
    And I should see "ADV Multi-sco DEFFINUM package"
    And I am on the "ADV Multi-sco DEFFINUM package" "deffinum activity" page
    And I should see "Enter"
    And I press "Enter"
  ...
  Scenario: Test force completed set to Always.
    When the following "activities" exist:
      | activity | course | name                          | packagefilepath                                               | forcenewattempt |
      | deffinum    | C1     | Basic Multi-sco DEFFINUM package | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12-mini.zip | 2               |
    And I am on the "Basic Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    And I should see "Enter"
    And I press "Enter"
    And I switch to "deffinum_object" iframe
  ...
  Scenario: Test force completed set to when previous complete/passed/failed.
    When the following "activities" exist:
      | activity | course | name                          | packagefilepath                                               | forcenewattempt |
      | deffinum    | C1     | Basic Multi-sco DEFFINUM package | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12-mini.zip | 1               |
    And I am on the "Basic Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    And I should see "Enter"
    And I press "Enter"
    And I switch to "deffinum_object" iframe
  ...
  Scenario: Test force completed set to Always and student skipview
    When the following "activities" exist:
      ...
      | deffinum    | C1     | Basic Multi-sco DEFFINUM package | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12-mini.zip | 2               | 2        |
    And I am on the "Basic Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    And I switch to "deffinum_object" iframe
    And I should see "Play of the game"
    And I switch to the main frame
  ...
  Scenario: Test force completed set to when previous complete/passed/failed.
    When the following "activities" exist:
      | activity | course | name                          | packagefilepath                                               | forcenewattempt | skipview |
      | deffinum    | C1     | Basic Multi-sco DEFFINUM package | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12-mini.zip | 1               | 2        |
    And I am on the "Basic Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    And I switch to "deffinum_object" iframe
    And I should see "Play of the game"
    And I switch to the main frame
