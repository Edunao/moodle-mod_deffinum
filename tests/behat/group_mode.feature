@mod @mod_deffinum
Feature: Viewing deffinum reports in separate and visible groups mode
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | deffinum    | C1     | Separate deffinum | mod/deffinum/tests/packages/singlescobasic.zip      | 0               | deffinum1   | 1         |
      | deffinum    | C1     | Visible deffinum  | mod/deffinum/tests/packages/singlescobasic.zip      | 0               | deffinum2   | 2         |
  ...
  groups in Separate groups mode, all groups in Visible groups mode.
    Given I am on the "<deffinum>" "deffinum activity" page logged in as "<user>"
    ...
    Examples:
      | deffinum  | user       | all        | G1         | G2         | user1  | user2      | user3      | user4      |
      | deffinum1 | teacher1   | should     | should     | should     | should | should     | should     | should     |
      | deffinum1 | noneditor1 | should not | should     | should not | should | should not | should not | should not |
      | deffinum1 | noneditor2 | should     | should not | should not | should | should     | should     | should     |
      | deffinum2 | teacher1   | should     | should     | should     | should | should     | should     | should     |
      | deffinum2 | noneditor1 | should     | should     | should     | should | should not | should not | should not |
      | deffinum2 | noneditor2 | should     | should     | should     | should | should not | should not | should not |
