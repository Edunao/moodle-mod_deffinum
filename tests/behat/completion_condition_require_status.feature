...
Feature: Deffinum multi-sco completion
  ...
  Scenario: Test completion with a single sco completion.
    Given the following "activity" exists:
      | activity                 | deffinum                                                    |
      | course                   | C1                                                       |
      | name                     | Basic Multi-sco DEFFINUM package                            |
      | completion               | 2                                                        |
      # Add requirements
      | completionstatusallscos  | 0                                                        |
      | packagefilepath          | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12.zip |
    ...
    Then I should see "Basic Multi-sco DEFFINUM package" in the "page" "region"
    And I am on homepage
    And I log out
    And I am on the "Course 1" course page logged in as teacher1
    Then "Student 1" user has completed "Basic Multi-sco DEFFINUM package" activity
  ...
  Scenario: Test completion with all scos and correct sco load on re-entry.
    Given the following "activity" exists:
      | activity                | deffinum                                                    |
      | course                  | C1                                                       |
      | name                    | ADV Multi-sco DEFFINUM package                              |
      | completion              | 2                                                        |
      # Add requirements
      | packagefilepath         | mod/deffinum/tests/packages/RuntimeMinimumCalls_DEFFINUM12.zip |
    ...
    And I follow "Exit activity"
    And I wait until the page is ready
    Then I should see "ADV Multi-sco DEFFINUM package" in the "page" "region"
    And I am on homepage
    And I log out

    And I am on the "Course 1" course page logged in as teacher1
    Then "Student 1" user has not completed "ADV Multi-sco DEFFINUM package" activity
    And I log out
    And I am on the "ADV Multi-sco DEFFINUM package" "deffinum activity" page logged in as student1
    And I should see "Enter"
    And I press "Enter"
    ...
    And I log out
    And I am on the "Course 1" course page logged in as teacher1
    And "Student 1" user has completed "ADV Multi-sco DEFFINUM package" activity
